...
// CreateVideoInlineRequest describe API request to iAGE platform to create new inline video creative
type CreateVideoInlineRequest struct {
	LineItemID              int      `json:"-"`
...
// NewCreateVideoInlineRequest initialize CreateVideoInlineRequest
func NewCreateVideoInlineRequest(lineItemID int, templateType int, name string, disabled bool, clickURL string, skipOffset int, videoFirstURL string, videoSecondURL string, videoStartDelay []int, thirdPartyUrls []string, events map[string][]string) *CreateVideoInlineRequest {
	request := &CreateVideoInlineRequest{
...
func (cvwr *CreateVideoInlineRequest) URL() string {
	return fmt.Sprintf(`/v1/lineitems/%v/creatives`, cvwr.LineItemID)
}

// Method return API request http method
func (cvwr *CreateVideoInlineRequest) Method() string {
	return http.MethodPost
}

// Body generate body content of API request
func (cvwr *CreateVideoInlineRequest) Body() io.Reader {
