...
// UpdateNativeVideoFeedRequest describe API request to iAGE platform to update video feed
type UpdateNativeVideoFeedRequest struct {
	ID                      int      `json:"-"`
...
// NewUpdateNativeVideoFeedRequest initialize UpdateNativeVideoFeedRequest
func NewUpdateNativeVideoFeedRequest(id int, templateType int, title string, brand string, description string, domain string, button string, disabled bool, clickURL string, iconURL string, imageURL string, videoFirstURL string, videoSecondURL string, videoStartDelay []int, thirdPartyUrls []string, events map[string][]string) *UpdateNativeVideoFeedRequest {
	request := &UpdateNativeVideoFeedRequest{
		ID:               id,
...
func (req *UpdateNativeVideoFeedRequest) URL() string {
	return fmt.Sprintf(`/v1/creatives/%v`, req.ID)
}

// Method return API request http method
func (req *UpdateNativeVideoFeedRequest) Method() string {
	return http.MethodPost
}

// Body generate body content of API request
func (req *UpdateNativeVideoFeedRequest) Body() io.Reader {
